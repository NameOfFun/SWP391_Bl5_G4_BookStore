        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_About_Title_NonEmpty", "LEN(LTRIM(RTRIM([Title]))) > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Author__70DAFC34FFED1BE6", x => x.AuthorId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookTag__657CF9AC0D8A39E4", x => x.TagId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A0B7D56E1D0", x => x.CategoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeSlider", x => x.HomeSliderId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Policy_Title_NonEmpty", "LEN(LTRIM(RTRIM([Title]))) > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountType = table.Column<string>(type: "nchar(1)", fixedLength: true, maxLength: 1, nullable: false),
                    ...
                    LastManagedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.LastManagedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromotionalPrice = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    PromotionalStartsAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    PromotionalEndsAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    PricingNote = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    LastPricingChangeAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    LastPricingChangeByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Book__3DE0C20785DAE3CC", x => x.BookId);
                    table.ForeignKey(
                        name: "FK_Book_AspNetUsers_LastPricingChangeByUserId",
                        column: x => x.LastPricingChangeByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK__Book__AuthorId__2A4B4B5E",
                        column: x => x.AuthorId,
                        principalTable: "Author",
                        principalColumn: "AuthorId");
                    table.ForeignKey(
                        name: "FK__Book__CategoryId__29572725",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiddenAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    HiddenByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookTagM__EBB70D9D3658287C", x => new { x.BookId, x.TagId });
                    table.ForeignKey(
                        name: "FK__BookTagMa__BookI__2F10007B",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId");
                    table.ForeignKey(
                        name: "FK__BookTagMa__TagId__300424B4",
                        column: x => x.TagId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerRequest", x => x.CustomerRequestId);
                    table.ForeignKey(
                        name: "FK_CustomerRequest_AspNetUsers_AssignedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookRating_UserId_BookId",
                table: "BookRating",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerRequest_AssignedToUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerRequest_UserId",
                table: "CustomerRequest",
                column: "UserId");
