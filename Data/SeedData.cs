...
public static class SeedData
{
    ...
    private static void SeedBookTags(BookStoreDbContext db)
    {
        db.BookTags.AddRange(
            ...
            new BookTag { TagId = 6, Name = "#bestseller",     IsActive = true },
            new BookTag { TagId = 7, Name = "#kinhdi",         IsActive = true }
        );
        db.SaveChanges();
    }
    ...
    private static void SeedAuthors(BookStoreDbContext db)
    {
        db.Authors.AddRange(
            ...
            new Author { AuthorId =  5, Name = "Paul Coelho",             IsActive = true },
            new Author { AuthorId =  6, Name = "José Mauro de Vasconcelos", IsActive = true },
            new Author { AuthorId =  7, Name = "Hector Malot",            IsActive = true },
            new Author { AuthorId =  8, Name = "Emma Hạ My",              IsActive = true },
            new Author { AuthorId =  9, Name = "Doo Vandenis",            IsActive = true },
            new Author { AuthorId = 10, Name = "Shindo Gonai",            IsActive = true },
            new Author { AuthorId = 11, Name = "Hồng Nương Tử",          IsActive = true }
        );
        db.SaveChanges();
    }
    ...
    private static void SeedBooks(BookStoreDbContext db)
    {
        var books = new List<Book>
        {
            new()
            {
                BookId = 1, CategoryId = 1, AuthorId = 1,
            ...
            new()
            {
                BookId = 2, CategoryId = 1, AuthorId = 2,
            ...
            new()
            {
                ...
                Price = 1000000, Stock = 300,
                ImageUrl = "https://sachxua.vn/wp-content/uploads/2020/01/dai-viet-su-ky-toan-thu-sach-ls.jpg",
                IsActive = true, CreatedAt = DateTime.Now,
            },
            new()
            {
                BookId = 4, CategoryId = 2, AuthorId = 4,
                Title = "Người Đàn Ông Mang Tên OVE",
                Description = "Người Đàn Ông Mang Tên Ove là tiểu thuyết đầu tay của nhà văn Thụy Điển Fredrik Backman, xuất bản năm 2012 và nhanh chóng trở thành một hiện tượng toàn cầu, được yêu mến bởi hàng triệu độc giả nhờ câu chuyện vừa hài hước, vừa cảm động về tình người. Cuốn sách kể về Ove, một người đàn ông 59 tuổi sống ở một khu dân cư nhỏ tại Thụy Điển, nổi tiếng với tính cách cộc cằn, nguyên tắc và luôn cáu kỉnh với mọi thứ xung quanh.",
                Price = 300000, Stock = 20,
                ImageUrl = "https://cdn1.fahasa.com/media/catalog/product/8/9/8934974182375.jpg",
                IsActive = true, CreatedAt = DateTime.Now,
            },
            new()
            {
                BookId = 5, CategoryId = 2, AuthorId = 5,
                Title = "Nhà Giả Kim",
            ...
            new()
            {
                BookId = 10, CategoryId = 3, AuthorId = 9,
            ...
            new()
            {
                BookId = 12, CategoryId = 3, AuthorId = 10,
        ...
        foreach (var (bookId, tagId) in mappings)
        {
            var book = db.Books.Find(bookId)!;
            var tag  = db.BookTags.Find(tagId)!;
            book.Tags.Add(tag);
        }
